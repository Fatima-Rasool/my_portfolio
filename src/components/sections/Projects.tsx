...
{
  title: "Oracle APEX ERP System",
  type: "Enterprise Web Application",
  showLive: true,
  featured: true,
  image: apexImg, // import image above
  description:
    "A business-focused ERP system developed using Oracle APEX with modules for inventory management, transactions, reporting, customer handling, and operational workflows. The project focuses on scalable database-driven architecture and enterprise process automation.",

  highlights: [
    "Inventory & transaction management",
    "Dynamic reports and interactive grids",
    "Database-driven enterprise workflows",
  ],

  tech: ["Oracle APEX", "PL/SQL", "SQL", "Oracle Database"],

  // live: "/oracle-apex-project",
    github: "https://github.com/Fatima-Rasool/oracle-showcase",
...

  {
    ...
    // github: "https://github.com/maryeem9/Sugarease/tree/main",
        ...
        github: "https://github.com/Fatima-Rasool/sugarsync",
...

{
  ...
  // github: "https://github.com/maryeem9/mern-thinkboard",
    ...
    github: "https://github.com/Fatima-Rasool/MERN-THINKBOARD",
  ...
  
  {
    ...
    // github: "https://github.com/maryeem9/AgriFert",
     github: "https://github.com/Fatima-Rasool/Agrifert",
  },
...
<a
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="flex items-center gap-2 text-gray-300 hover:text-[#c4a18e]"
>
